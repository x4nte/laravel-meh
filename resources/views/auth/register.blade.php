    ...
    <section class="bg-black min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-md space-y-8">
            <div class="bg-black border border-white/10 rounded-2xl p-8 shadow-lg transition-all">
                ...
                <form method="POST" action="/register" class="space-y-6 mt-2">
                    @csrf
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-300 mb-1">Подтвердите
                            пароль</label>
                        <input
                    ...
                    <div class="text-center pt-4 border-t border-white/10">
                        <p class="text-gray-400 text-sm">
                            Уже есть аккаунт?
                            <a href="/login" class="text-white hover:text-gray-300 font-semibold underline">Войти</a>
                        </p>
                    </div>
                </form>
            </div>
